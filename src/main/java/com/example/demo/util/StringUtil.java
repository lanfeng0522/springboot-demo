...
//		System.out.println(StringUtil.delComma("1111307.06"));
	 ...
	 * @return
	 */
	public static String fillString(String seq,int length,String symbol){
	 ...
	 * @return
	 */
	public static String random(int precision){
        int ans = 0;
        while(Math.log10(ans)+1<precision)
            ans = (int)(Math.random()*Math.pow(10, precision));
	 ...
	 */
	public static void vaildIsEmpty(Object param) {
	...
	public static void main(String[] args) {
		...
		System.out.println(getLength("反倒是as"));
	}
	...
	public static String addZero(String str, int length){
	    ...
	    if(strLength > length){
	    	...
	    	return sb.toString().substring(0, length - str.length()) + str;
	    }
